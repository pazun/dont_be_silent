export default {
  ...
  user: {
    ...
    newName: 'New Name',
    newNameRequired: 'Please input your new name!',
    ...
    failedToFetchUserInfo: 'Failed to fetch user information',
    failedToConnectServer: 'Failed to connect to server',
    signInToChangePassword: 'Please sign in to change your password',
    passwordChangedSuccessfully: 'Password changed successfully',
    failedToChangePassword: 'Failed to change password',
    signInToChangeName: 'Please sign in to change your name',
    nameChangedSuccessfully: 'Name changed successfully',
    failedToChangeName: 'Failed to change name',
    ...
    signInToUpdateSettings: 'Please sign in to update settings',
